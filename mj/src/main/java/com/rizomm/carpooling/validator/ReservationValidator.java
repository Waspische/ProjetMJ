...
public class ReservationValidator implements Validator {
	...
	public void validate(Object obj, Errors e) {
		...
		//Point Depart
		if(reservationForm.getPointDepart()!="" && villeService.getVilleByLibelle(reservationForm.getPointDepart())==null)
		{
			e.rejectValue("pointDepart", "erreur.pointDepart", new String[]{"pointDepart"}, "La ville de départ n'existe pas en base.");
		}
		
		//Point Arrivee
		if(reservationForm.getPointArrivee()!="" && villeService.getVilleByLibelle(reservationForm.getPointArrivee())==null)
		{
		...
		if(reservationForm.getPointDepart()!="" && reservationForm.getPointArrivee()!=null && reservationForm.getPointDepart().equals((reservationForm.getPointArrivee())))
		{
		...
		if(reservationForm.getDateDepart()!="")
		{
			...
			try {
				formatter.parse(reservationForm.getDateDepart());
			} catch(Exception ex) {
