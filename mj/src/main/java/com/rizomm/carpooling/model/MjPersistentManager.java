...
public class MjPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Mj";
	...
	private MjPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MjPersistentManager();
		}
